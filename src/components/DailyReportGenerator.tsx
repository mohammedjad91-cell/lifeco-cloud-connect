    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        <FormField
          ...
          hint="Include the country code, digits only. Leave empty to pick a chat in WhatsApp."
        >
          {(id) => (
        ...
        <FormField
          ...
          hint="Opens Gmail with the report text prefilled. Leave empty to choose the recipient there."
        >
          {(id) => (
            <div className="flex gap-2">
              <Input
      ...
      <FormField
        label="Report draft"
        hint="Generated by AI from today's readings — edit freely before exporting or sharing."
      >
        {(id) => (
          <Textarea
            id={id}
            ...
            rows={16}
            placeholder="Press Generate to build the report, then share it via WhatsApp or Gmail."
