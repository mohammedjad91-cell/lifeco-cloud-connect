...
const LAB_AMMONIA_MODULES: PlantModule[] = [
  ...
  { key: "sample-reg", label: "Sample Registration", labelAr: "تسجيل العينات", route: "/lab#samples" },
  { key: "sample-track", label: "Sample Tracking", labelAr: "تتبع العينات", route: "/lab#samples" },
  { key: "chem-analysis", label: "Chemical Analysis", labelAr: "التحليل الكيميائي", route: "/lab#samples" },
  { key: "gas-analysis", label: "Gas Analysis", labelAr: "تحليل الغازات", route: "/lab#samples" },
  { key: "water-analysis", label: "Water Analysis", labelAr: "تحليل المياه", route: "/lab#samples" },
  { key: "qc", label: "Quality Control", labelAr: "ضبط الجودة", route: "/lab" },
...
const LAB_UREA_MODULES: PlantModule[] = [
  ...
  { key: "sample-reg", label: "Sample Registration", labelAr: "تسجيل العينات", route: "/lab#samples" },
  { key: "sample-track", label: "Sample Tracking", labelAr: "تتبع العينات", route: "/lab#samples" },
  { key: "prod-analysis", label: "Product Analysis", labelAr: "تحليل المنتج", route: "/lab#samples" },
  { key: "water-analysis", label: "Water Analysis", labelAr: "تحليل المياه", route: "/lab#samples" },
  { key: "qc", label: "Quality Control", labelAr: "ضبط الجودة", route: "/lab" },
  { key: "equipment", label: "Laboratory Equipment", labelAr: "معدات المختبر" },
  { key: "calibration", label: "Calibration", labelAr: "المعايرة" },
