...
const translations = {
  ...
  ar: {
    ...
    language: "يا أخويا أنا نقصد بالتصاريح هذين أوامر عمل يوجد في داخل المصنع داخل في كل مصنع وليس في الواجهة الرئيسية. ركز معايا، احذف الذي قمت بوضعه على الواجهة الرئيسية أرجوك.",
  },
} as const;
