...
const translations = {
  ...
  ar: {
    ...
    language: "تمام، الـ آآآ تم التحسين ولكن الـ آآ ما زالت الـ آآ الخانة الأولى هي المعلومات العامة آآآ الداخل تصريح العمل. آآآ الخط ما زال ضعيف، نبي تدكين الخط وكل شي فيه.",
  },
} as const;
