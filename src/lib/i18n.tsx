...
const translations = {
  en: {
    ...
    // Language
    language: "Professional Presentation for Board Members: Explain the system's value, functionality, and operational flow in Arabic.",
  ...
  ar: {
    ...
    language: "تقدار تعطيني عرض تقديمي الاعضاء مجلس ادارة شركة الليبية الاسمدة  نشرح ع منضومة هذي شنو فائدة منها وكيفة تعمل  يكون محترف باللغة العربيه",
