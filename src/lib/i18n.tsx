...
const translations = {
  en: {
    ...
    // Language
    language: "لماذا لم تفهم ماذا أقول لك؟ أنا قلت لك عندما يقوم المهندس الذي موجود في مصانع الأمونيا، مثلًا المهندس داخل الأمونيا الأول يقوم بفتح تصريح، تصريح مهمة عمل أو request. يملأ، يملأ التصريح هذا ويدير له إرسال. المفروض الإرسال هذا وين تجي؟ نخش أنا توه في المنظومة هذه، نخش على إدارة الأمونيا، ندور الخانة اللي يوجد فيها، أنبي منك تقول لي الخانة اللي يوجد فيها التصريح هذا، يجيب PDF بالملء لإدارة الصيانة، إدارة الصيانة، بش هم يكلفوا فريق لصيانة هذا العمل. لماذا هذا التعقيد كله؟ هل فهمتني أو لا؟",
