...
const translations = {
  ...
  ar: {
    ...
    language: "WORK PERMIT / تصريح عمل\n\n\n\n\nنبي منك آآآ عند الدخول على تصريح العمل آآآ في، في خانة الرقم واحد اللي هي المعلومات العامة، الخط غير واضح، يجب تدكين الخط كاملًا داخل البوكس هذا، وكذلك في تحديد المخاطر رقم اتنين حتى هو الخط مش واضح، الكلمات اللي جنب البوكسات مش واضحات، وكذلك تجهيز العمل الأمن حتى هو مش واضح، وم- ومعدات الوقاية كذلك، وفحص الغاز، وقائمة التحقق من موقع العمل حتى هي مش واضحة، الخط بتاعها مش واضح، وإغلاق التصريح حتى هو كذلك. نبي منك تدكن الخط ويكون خط أسود عشان الخلفية بيضا مش يبان.",
  },
} as const;
