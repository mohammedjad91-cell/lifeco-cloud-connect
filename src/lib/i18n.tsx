...
const translations = {
  en: {
    ...
    // Language
    language: "هي المفروض اول ما ادخل الي إدارة الصيانة المفروض تكون هناك خانة نلقى فيها التصريح المراسل من جميع المصانع انا نحكي معك كاني موظف في ادارة الصيانة",
