...
const translations = {
  en: {
    ...
    // Language
    language: "Goal\n\n- Redesign the main interface to correct existing errors and improve overall user experience.\n\nScreens\n\n- Home screen: revise layout and content to eliminate mistakes and inconsistencies.\n\n- Error handling: implement intuitive error messages and recovery options.\n\nComponents\n\n- Navigation: ensure seamless and logical flow between sections.\n\n- Typography: select clear, readable fonts to enhance user engagement.\n\nData\n\n- User input: validate and sanitize data to prevent errors and inconsistencies.\n\n- Feedback mechanisms: provide clear and timely feedback to users.\n\nStates\n\n- Loading state: design a responsive and informative loading screen.\n\n- Empty state: create an engaging and helpful empty state screen.\n\n- Error state: develop a user-friendly error state screen with recovery options.\n\nUX\n\n- Mobile responsiveness: ensure the interface is fully responsive and adaptable to various mobile devices.\n\n- Accessibility: incorporate features that cater to diverse user needs and abilities.\n\nAcceptance\n\n- Test the redesigned interface for usability, functionality, and performance.\n\n- Validate user feedback and make necessary adjustments to ensure a seamless user experience.",
    اكمل: "اكمل",
  },
  ar: {
    lifecoDigital: "LIFECO PMS 2026",
