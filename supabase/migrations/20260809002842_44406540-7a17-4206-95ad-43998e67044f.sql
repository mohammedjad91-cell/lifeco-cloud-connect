-- First ensure the tag is correct in equipment_assets for the asset linked to 60-2201
UPDATE public.equipment_assets 
SET 
    tag = '60-2201',
    asset_name = 'Dryer',
    status = 'Pending Verification'
WHERE id = '39611a25-4703-4cba-aa72-20f549c07fd4';

-- Update equipment_identity_cards for 60-2201
...
[PROCESS FLOW]
60-2002 Air Receiver → 60-2201 Dryer → 60-2003 Air Receiver
...
- Operating Manual Required for detailed maintenance sequences.',
    ...
    updated_at = NOW()
WHERE asset_id = '39611a25-4703-4cba-aa72-20f549c07fd4';