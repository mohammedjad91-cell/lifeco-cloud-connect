-- Digital Transformation Forms for LIFECO
...
CREATE TABLE public.lifeco_digital_forms (
    ...
    form_type lifeco_form_type NOT NULL,
    form_number TEXT UNIQUE NOT NULL, -- Automatically generated format e.g. WP-2026-0001
    status lifeco_form_status NOT NULL DEFAULT 'draft',
    ...
    -- Signatures (stored in JSONB or separate for security)
    signatures JSONB NOT NULL DEFAULT '[]'::jsonb,
    
    -- Audit
    created_by_name TEXT NOT NULL,
    created_by_id TEXT, -- User reference if available
